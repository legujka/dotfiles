...
- [ ] OS specific configs
    - `./home` - Universal configs
    - `./linux_home` - Linux-specific configs with linux-based tools and keymaps
    - `./osx_home` - macOS-specific configs with osx-based tools and keymaps
